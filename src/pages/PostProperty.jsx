...
function PostProperty() {
  ...
  const brokerFeature = {
    imgs: [
      "https://assets.nobroker.in/static/img/listing/icon1.png",
      "https://assets.nobroker.in/static/img/listing/icon2.png",
      "https://assets.nobroker.in/static/img/listing/icon3.png",
    ],
    title: ["No Calls From Brokers", "Verified Tenants", "Save Brokerage"],
    content: [
      "Your information is kept confidential and you no longer have to worry about call from brokers.",
      "Thanks to our technology, only verified and genuine tenants can call you.",
      "No Brokers means No Brokerage! Buy yourself a gift",
    ],
  };
  return (
    <>
      <div className="container" style={{ marginTop: "100px" }}>
        ...
        <div className="row mt-5">
          {brokerFeature.imgs.map((img, index) => (
            <div
              key={index}
            ...
            >
              <img
                className="mb-3"
                style={{ height: "30px", height: "50px" }}
                src={img}
                alt={brokerFeature.title[index]}
              />
              <h5
                className="fw-semibold"
                style={{ fontSize: "18px", color: "#424949" }}
              >
                {brokerFeature.title[index]}
              </h5>
              <p className="" style={{ fontSize: "15px", color: "#787676" }}>
                {brokerFeature.content[index]}
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-5">
          ...
          <p style={{color: "#767979"}}>NoBroker makes it easy to sell property online or list your property for rent with a simple, streamlined process that connects you directly with tenants or buyers. Here’s how it works:</p>

          <h3 className="fs-6" style={{color:"#464949"}}><span><strong>1. Easy Property Listing Process</strong></span></h3>
          <p style={{color:"#767979"}}>Post a free property ad on NoBroker within minutes. Simply fill out our easy-to-use form with all the relevant details, including location, amenities, and photos. Your property advertisement will go live after a quick verification.</p>
        </div>
      </div>
    </>
  );
